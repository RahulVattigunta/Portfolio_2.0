...
const socialLinks = [
  {
    name: 'GitHub',
    url: 'https://github.com/RahulVattigunta',
    icon: (
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/rahul-vattigunta/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="relative dark:bg-black">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          >
            <a
              href="https://github.com/RahulVattigunta"
              target="_blank"
              rel="noopener noreferrer"
          ...
          >
            <p className="text-center text-sm text-neutral-600 dark:text-neutral-400">
              © {currentYear} Rahul Vattigunta. All rights reserved.
            </p>
          </motion.div>
        </div>
      </div>
