      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              Full-Stack Software Engineer with a Master’s in Computer Science and 4 years of experience building scalable web applications, cloud-native microservices, and REST APIs using Java, Python, React.js, Docker, and AWS. 
              Proven track record in backend development, CI/CD automation, and frontend performance optimization. 
              Passionate about clean code, system design, and delivering production-ready solutions in Agile environments.
            </motion.p>
